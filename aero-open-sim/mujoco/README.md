...
This package contains a **tendon-driven** robotic hand model for MuJoCo manipulation tasks. The Tetheria Aero Hand Open features accurate cable-driven actuation with spatial tendons, springs, and pulleys that match the real hand's mechanical design.
